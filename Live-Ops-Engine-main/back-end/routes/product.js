...
router.get("/karthik/signup", (req, res) => {
    res.send("signup Route working!!")
})



router.post("/api/karthik/signup",
...
router.put("/api/karthik/user/:emailId",
    async (req, res) => {
...
router.get("/api/karthik/userlist", async (req, res) => {
    try {
...
router.delete("/api/karthik/delete/:id", async (req, res) => {
    try {
